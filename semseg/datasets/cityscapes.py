...
class CityScapes(Dataset):
    ...
    SMALL_OBJECT = [5, 6, 7, 11, 12, 17, 18]
    ...
    def __getitem__(self, index: int) -> Tuple[Tensor, Tensor]:
        ...
        lbl_path = str(self.files[index]).replace('leftImg8bit', 'gtFine').replace('.png', '_labelTrainIds.png')
