...
# def main(cfg, gpu, save_dir):
    ...
    trainset = eval(dataset_cfg['NAME'])(dataset_cfg['ROOT'], transform=traintransform, split='train',
                                           domain_idx_list=[1, 2], is_out_domain=True, test_domain_idx=0, preload=False)
    valset = eval(dataset_cfg['NAME'])(dataset_cfg['ROOT'], transform=valtransform, split='test',
                                         domain_idx_list=[1, 2], is_out_domain=True, test_domain_idx=0, preload=False)
