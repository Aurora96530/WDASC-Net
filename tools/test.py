...
def main(cfg, args):
    ...
    dataset = eval(cfg['DATASET']['NAME'])(cfg['DATASET']['ROOT'], 'test', transform, postfix_dir=postfix_dir)
    # dataset = eval(cfg['DATASET']['NAME'])(cfg['DATASET']['ROOT'], transform=transform, split='test',
