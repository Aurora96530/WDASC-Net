...
class SemSeg:
    def __init__(self, cfg) -> None:
        ...
        # self.norm = T.Normalize([0.318, 0.199, 0.083], [0.299, 0.162, 0.085])  # DDR
        # self.norm = T.Normalize((0.457, 0.221, 0.064), (0.315, 0.224, 0.052))  # IDRiD
        # self.norm = T.Normalize((0.179, 0.101, 0.052), (0.112, 0.073, 0.053))  # FGADR
...
if __name__ == '__main__':
    ...
    save_dir = Path(cfg['SAVE_DIR']) / 'test_rct12'
